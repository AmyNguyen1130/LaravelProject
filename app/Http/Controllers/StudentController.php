...
class StudentController extends Controller
{
    ...
    function getWaterByMonth(Request $req){
        $water = Water::select('waters.id', 'rooms.name as room_name','rooms.id as room_id', 'time', 'old_number', 'new_number', 'price', 'status')->join('rooms', 'rooms.id', '=', 'waters.room_id')->where('waters.time', $req->month_water)->get();
        // return view('student.pages.bill', compact('water'));
