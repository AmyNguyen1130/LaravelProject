...
class MisconductsTableSeeder extends Seeder
{
	...
	public function run()
	{
		DB::table('misconducts')->insert([
			...
			['student_id' => 9, 'content' => 'Không mang dép quay hậu', 'time' => '2019-4-04', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Quên thẻ', 'time' => '2019-4-05', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Đi học muộn', 'time' => '2019-2-04', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Quên thẻ', 'time' => '2019-4-10', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Không đúng đồng phục', 'time' => '2019-4-22', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Quên thẻ', 'time' => '2019-4-27', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Không cất xe đạp đúng nơi quy định', 'time' => '2019-4-21', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Đi học muộn', 'time' => '2019-4-09', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Quên thẻ', 'time' => '2019-3-29', 'minus' => 30000],
			['student_id' => 9, 'content' => 'Không đúng đồng phục', 'time' => '2019-4-11', 'minus' => 30000],
		]);
	}
}
