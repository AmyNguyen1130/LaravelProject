...
class IssusesTableSeeder extends Seeder
{
	...
	public function run()
	{
		DB::table('issues')->insert([
			...
			['content' => 'Hư bóng đèn nhà tắm', 'student_id' => 1, 'room_id' => 1,'created_at'=>'2018-12-01','updated_at'=>'2018-12-01'],
			['content' => 'Hư óng nước', 'student_id' => 2, 'room_id' => 2,'created_at'=>'2019-01-01','updated_at'=>'2019-01-01'],
			['content' => 'Hư nồi cơm điện', 'student_id' => 3, 'room_id' => 3,'created_at'=>'2019-02-01','updated_at'=>'2019-02-01'],
			['content' => 'Hư chốt cửa', 'student_id' => 4, 'room_id' => 4,'created_at'=>'2019-03-01','updated_at'=>'2019-02-01'],
			['content' => 'Hư tủ lạnh', 'student_id' => 5, 'room_id' => 5,'created_at'=>'2019-04-01','updated_at'=>'2019-04-01'],
			['content' => 'Hư quạt', 'student_id' => 6, 'room_id' => 6,'created_at'=>'2019-05-01','updated_at'=>'2019-05-01'],
			['content' => 'Hư quạt', 'student_id' => 7, 'room_id' => 7,'created_at'=>'2019-04-01','updated_at'=>'2019-04-01'],
		]);
	}
}
